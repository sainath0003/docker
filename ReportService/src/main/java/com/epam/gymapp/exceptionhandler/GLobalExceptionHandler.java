...
public class GLobalExceptionHandler {
	...
	public ExceptionResponse handleTraineeException(ReportException e, WebRequest request,
	...
	public ExceptionResponse handleTraineeNoyFoundException(ReportNotFoundException e, WebRequest request,
			HttpServletRequest serrequest) {
		log.error(e.getMessage());
